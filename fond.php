...
<body class="about-page">
    ...
    <?php include __DIR__ . '/partials/main-banner.php'; ?>
    ...
    <div class="container_rg">
        <section class="about-section">
            ...
            <div class="about-section__content">
                <?php include __DIR__ . '/partials/napravleniya.php'; ?>
            </div>
        ...
        <section class="about-section">
            ...
            <div class="about-section__content">
                <?php include __DIR__ . '/partials/team.php'; ?>
            </div>
        ...
        <section class="about-section">
            ...
            <div class="about-section__content">
                <?php include __DIR__ . '/partials/feedback.php'; ?>
            </div>
        ...
        <section class="about-section_divided">
            <div class="recviz">
                ...
                <div class="recviz__wrap">
                    <?php include __DIR__ . '/partials/recviz.php'; ?>
                </div>
            </div>
